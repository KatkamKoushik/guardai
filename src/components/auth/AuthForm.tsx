        ...
        <GlassCard>
          ...
          <div className="space-y-3 mb-6">
            <MagneticButton 
              ...
              onClick={() => alert("Google OAuth flow initiated")}
            >
            ...
            <MagneticButton 
              variant="secondary" 
              className="w-full justify-center"
              onClick={() => alert("GitHub OAuth flow initiated")}
            >
              <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-[#0a0a0a] text-white/30" style={{ fontFamily: "var(--font-mono)" }}>
                OR
              </span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <AnimatePresence mode="wait">
              {authMode === "signup" && (
                ...
                >
                  <label className="block text-xs text-white/40 mb-2" style={{ fontFamily: "var(--font-mono)" }}>
                    NAME
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-3 bg-[#0a0a0a] border border-white/10 rounded-lg text-white text-sm placeholder-white/30 focus:outline-none focus:border-[#00F0FF]/50 transition-colors"
                  />
                </motion.div>
              )}
            </AnimatePresence>
            ...
            {authMode === "login" && (
              <div className="flex justify-end">
                <button
                  type="button"
                  className="text-xs text-[#00F0FF]/60 hover:text-[#00F0FF] transition-colors"
                >
                  Forgot password?
                </button>
              </div>
