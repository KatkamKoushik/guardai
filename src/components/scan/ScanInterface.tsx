                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <motion.div 
                      ...
                      className="p-6 rounded-xl bg-white/5 border border-white/5 flex items-center gap-6"
                    >
                      <div className="relative w-24 h-24">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <span className="text-xl font-bold" style={{ color: threatColor }}>
                            {result.score}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="p-6 rounded-xl bg-white/5 border border-white/5 flex flex-col justify-center">
                      <div className="text-xs text-white/40 mb-3 font-mono">THREAT INTELLIGENCE</div>
                    ...
                    <div className="p-6 rounded-xl bg-white/5 border border-white/5">
                      <div className="text-xs text-white/40 mb-2 font-mono">ML LEXICAL PROBABILITY</div>
                      <div className="mb-4">
                    ...
                    {/* SSL */}
                    <div className="p-6 rounded-xl bg-white/5 border border-white/5">
                      <div className="text-xs text-white/40 mb-2 font-mono">SSL / TLS CERTIFICATE</div>
                      <div className="flex items-center gap-3 mb-2">
                        <div className={`w-2 h-2 rounded-full ${result.details.ssl.valid ? 'bg-[#00FF66]' : 'bg-[#FF003C]'}`} />
                        <div className="text-lg">{result.details.ssl.issuer}</div>
                      </div>
